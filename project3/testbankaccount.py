...
class TestBankAcount(unittest.TestCase):
    ...
    def test_legal_deposit_works(self):
        ...
        temp = self.account.balance
        self.account.deposit_funds(1500)
        self.assertGreater(self.account.balance, temp)
    ...
    def test_illegal_deposit_raises_exception(self):
        ...
        # raised.
        try:
            self.account.deposit_funds("dumbbell")
        except ValueError:
            pass
    ...
    def test_legal_withdrawal(self):
        ...
        self.assertLess(self.account.balance, temp)
    ...
    def test_illegal_withdrawal(self):
        ...
        try:
            self.account.withdraw_funds("barbell")
        except ValueError:
            pass
        except Exception as e:
            self.fail(str(e))
    ...
    def test_insufficient_funds_withdrawal(self):
        ...
        try:
            self.account.withdraw_funds(50000)
        except Exception as e:
            pass
